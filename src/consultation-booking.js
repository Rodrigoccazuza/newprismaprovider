  ...
  function renderContact() {
    return `
      ...
      <div class="booking-fields">
        ...
        <label>Preferred language<select name="booking-language"><option value="English"${selected('booking-language', 'English', true)}>English</option><option value="Português"${selected('booking-language', 'Português')}>Português</option><option value="Español"${selected('booking-language', 'Español')}>Español</option></select></label>
        ...
        <label>How did you find us<select name="booking-source"><option value="Google"${selected('booking-source', 'Google', true)}>Google</option><option value="A friend or family member"${selected('booking-source', 'A friend or family member')}>A friend or family member</option><option value="Instagram"${selected('booking-source', 'Instagram')}>Instagram</option><option value="WhatsApp"${selected('booking-source', 'WhatsApp')}>WhatsApp</option><option value="Another provider"${selected('booking-source', 'Another provider')}>Another provider</option><option value="Other"${selected('booking-source', 'Other')}>Other</option></select></label>
      </div>`
  }
  ...
  function renderDetails() {
    return `
      ...
      <div class="booking-fields">
        ...
        <label>Has anything been filed before<select name="booking-filed"><option value="Nothing has been filed"${selected('booking-filed', 'Nothing has been filed', true)}>Nothing has been filed</option><option value="Something was filed and is pending"${selected('booking-filed', 'Something was filed and is pending')}>Something was filed and is pending</option><option value="A case was denied"${selected('booking-filed', 'A case was denied')}>A case was denied</option><option value="I am not sure"${selected('booking-filed', 'I am not sure')}>I am not sure</option></select></label>
        ...
        <label>Documents you already have<select name="booking-docs"><option value="Almost everything"${selected('booking-docs', 'Almost everything', true)}>Almost everything</option><option value="Some documents"${selected('booking-docs', 'Some documents')}>Some documents</option><option value="Very little"${selected('booking-docs', 'Very little')}>Very little</option><option value="I do not know what is needed"${selected('booking-docs', 'I do not know what is needed')}>I do not know what is needed</option></select></label>
