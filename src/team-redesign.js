...
if (teamSection) {
  ...
  style.textContent = `
    ...
    .team-editorial-shell{position:relative;padding:14px;border:1px solid #ffffffa8;border-radius:38px;overflow:hidden;background:linear-gradient(145deg,rgba(245,247,249,.94),rgba(173,180,188,.86) 46%,rgba(224,228,232,.92));backdrop-filter:blur(28px) saturate(.85);-webkit-backdrop-filter:blur(28px) saturate(.85);box-shadow:inset 0 1px #fff,inset 0 -1px #60666d4f,0 32px 75px #0008}
    ...
    .team-editorial-panel{position:relative;z-index:1;padding:44px 44px 46px;border:1px solid rgba(255,255,255,.58);border-radius:29px;background:linear-gradient(155deg,rgba(247,249,251,.72),rgba(206,212,218,.58) 52%,rgba(238,241,244,.68));backdrop-filter:blur(20px) saturate(.88);-webkit-backdrop-filter:blur(20px) saturate(.88);color:#101315;overflow:hidden;box-shadow:inset 0 1px rgba(255,255,255,.9),inset 0 -1px rgba(96,102,109,.18)}
    ...
    .team-editorial-card{position:relative;flex:0 0 min(430px,70vw);min-height:590px;border:1px solid #17191b1c;border-radius:28px;overflow:hidden;background:linear-gradient(145deg,rgba(245,247,249,.88),rgba(205,211,217,.82));scroll-snap-align:start;box-shadow:inset 0 1px #fff8;display:grid;grid-template-rows:auto 1fr}.team-editorial-card--featured{background:linear-gradient(145deg,#c8ff77,#aef252 76%);border-color:#b7f46c}
