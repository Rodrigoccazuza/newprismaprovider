...
function enhancePrismaSite() {
  if (!document.querySelector('#line-awesome-prisma-styles')) {
    ...
    iconStyles.textContent = `
      ...
      /* How it works: former hover state is now the permanent default */
      .process-line{border-color:rgba(255,255,255,.62)!important;background:linear-gradient(145deg,rgba(244,247,249,.17),rgba(160,168,177,.11) 45%,rgba(224,229,233,.14))!important;backdrop-filter:blur(26px) saturate(.9)!important;-webkit-backdrop-filter:blur(26px) saturate(.9)!important;box-shadow:inset 0 1px rgba(255,255,255,.52),inset 0 -1px rgba(90,98,107,.2),0 28px 72px rgba(0,0,0,.46)!important;transform:none!important}.process-line:before{opacity:1!important}.process-line .process-step{padding-inline:24px!important;border-bottom-color:rgba(255,255,255,.17)!important;background:transparent!important}.process-line .process-step h3{color:#f7f8f9!important}.process-line .process-step p{color:#b9bec5!important}.process-line .process-step small{color:#d7dbe0!important}.process-line:hover{transform:none!important}.process-line:hover .process-step{padding-inline:24px!important;background:transparent!important}.process-line .process-step:hover{background:transparent!important;box-shadow:none!important}.process-line .process-step:hover>span{color:inherit!important;border-color:inherit!important;background:inherit!important;box-shadow:inherit!important;transform:none!important}.process-line .process-step:hover .process-step__icon i{transform:none!important}
      ...
      @media(max-width:720px){.process-step__icon{width:44px!important;height:44px!important}.process-step__icon i{font-size:20px}.process-line .process-step,.process-line:hover .process-step{padding-inline:14px!important}.team-section--profile .section-heading{text-align:left}.team-profile-card{min-height:590px;border-radius:30px;padding:9px}.team-profile-card__media{min-height:570px;border-radius:23px}.team-profile-card__content{left:25px;right:25px;bottom:24px}.team-profile-card__name{font-size:29px}.team-profile-card__bio{font-size:12px}.team-profile-card__stats{margin:20px 0}.team-profile-card__stats div{padding:0 9px}.team-profile-card__actions{grid-template-columns:1fr 50px}.team-profile-card__contact,.team-profile-card__save{min-height:50px}.review-card:hover{transform:none!important}}
