...
function enhancePrismaSite() {
  if (!document.querySelector('#line-awesome-prisma-styles')) {
    ...
    iconStyles.textContent = `
      ...
      @media(prefers-reduced-motion:reduce){.process-step__icon i,.team-profile-card,.team-profile-card__media img,.team-profile-card__contact,.team-profile-card__save{transition:none!important;transform:none!important}}
    `
